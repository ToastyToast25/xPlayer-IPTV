         ...
         <div class="modal-dialog">
            ...
            <div class="modal-content row">
               <div class="modal-header custom-modal-header">
                  ...
                  <p><?php echo HOME_TXT_TESTE_DESC; ?><br> for <?php echo HORAS; ?> <?php echo HOME_TXT_HORAS; ?></p>
               </div>
               <div class="modal-body">
                  ...
                  <input type="hidden" name="op" value="criarteste">
                     ...
                     <div class="form-group col-sm-12">
                        <button class="subscribe-btn pull-right" type="submit" title="Send"><?php echo HOME_BOTAO_TESTE; ?></button>
                     </div>
                  </form>
               </div>
            </div>
